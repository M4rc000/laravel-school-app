              ...
              if (res && res.length > 0) {
                  for (var i = 0; i < res.length; i++) {
                      $('#tbody-tbl-menu').append(`
                          <tr>
                            <td>${i + 1}</td>
                            <td><img src="{{ asset('storage/') }}/${res[i].picture}" width="30" height="30"></td>
                            <td>${res[i].name}</td>
                            <td>${res[i].email}</td>
                            <td>${res[i].country === null || res[i].country.length < 1 ? '-' : res[i].country}</td>
                            <td>${res[i].gender === null || res[i].gender.length < 1 ? '-' : res[i].gender}</td>
                            <td>
