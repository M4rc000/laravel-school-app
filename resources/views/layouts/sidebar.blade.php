...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @foreach ($submenus as $submenu)
            <li class="menu-item active">
                <a href="/{{ $submenu->url }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">{{ $submenu->title }}</div>
                </a>
            </li>
        @endforeach --}}
        {{-- @foreach ($menus as $menu)
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">{{ $menu->name }}</span> <!-- Assuming 'name' exists in Menu model -->
            </li>
            
            <!-- Render Submenus Associated with Menu -->
        ...
        <li class="menu-header small text-uppercase">
            ...
            @foreach ($submenus->where('menu_id', $menu->id) as $submenu)
            <li class="menu-item {{ $submenu->url == $path ? 'active' : '' }}">
                <a href="/{{ $submenu->url }}" class="menu-link">
                <i class="menu-icon tf-icons {{ $submenu->icon }}"></i>
                <div data-i18n="Analytics">{{ $submenu->name }}</div>
                </a>
            </li>
            @endforeach
        @endforeach
